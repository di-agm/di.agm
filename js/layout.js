    ...
    /*function addShapeElement(shapeType = 'circle') {
          ...
          ['circle', 'polygon', 'star'].forEach(opt => {
            const option = document.createElement('option');
            option.value = opt;
            option.textContent = opt;
            if (opt === shapeType) option.selected = true;
          ...
          toolbar.appendChild(changeBtn);
          toolbar.appendChild(deleteBtn);
          toolbar.appendChild(shapeSelect);
          element.appendChild(toolbar);
          ...
          // ---- Toolbar Actions ----
          changeBtn.addEventListener('click', () => {
            shapeSelect.style.display = shapeSelect.style.display === 'none' ? 'block' : 'none';
          });
          ...
          // show toolbar only when element is selected
